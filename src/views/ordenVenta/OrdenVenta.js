...
const OrdenVenta = () => {
                    ...
                    <>
                      {itemOrden.estado == '4' ? (
                        ...
                        <Button
                          ...
                          title="Asignar orden"
                          onClick={() => asignarOrden(itemOrden.idOrden, console.log("BOTON ASIGNAR:", itemOrden.idOrden))}
  ...
  const asignarOrden = (idOrden) => {
    console.log("Entro al metodo asignar")
    if (ordenSeleccionada.idOrden !== null && usuarioAsignado !== 0) {
      ...
      console.log("ORDEN: ", ordenSeleccionada.idOrden);
      formData.append('asignadoPor', window.usuario.idUsuario);
      console.log("ASIGNADO POR: ", window.usuario.idUsuario);
      formData.append('asignadoA', usuarioAsignado);
      console.log("ASIGNADO A: ", usuarioAsignado);
